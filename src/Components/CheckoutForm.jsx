...
export default function CheckoutForm() {
  ...
  useEffect(() => {
    axios.get("https://deploy-back-mangaka-v2.herokuapp.com/api/profile/coins", { withCredentials: true })
      .then(data => {
  ...
  function handleSubmit(e) {
    ...
    axios.post('https://deploy-back-mangaka-v2.herokuapp.com/api/coins/sell', input, { withCredentials: true })
