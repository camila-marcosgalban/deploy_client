...
export const getPacksById = BASE_URL + 'api/coins/pack'
export const buyCoins = BASE_URL + 'api/coins/buy'
export const getChapterById = BASE_URL + 'api/chapters/chapter/getchapter'
export const wishlist = BASE_URL + 'api/profile/wishlist'
export const deleteWishlist = BASE_URL + 'api/users/user/lists?list=wishList'
export const addWishlist = BASE_URL + 'api/users/user/lists?list=wishList'
