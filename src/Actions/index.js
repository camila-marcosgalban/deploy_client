    ...
    return async (dispatch) => {
        try {
            ...
            let setActive = await axios.put(
                 `https://deploy-back-mangaka-v2.herokuapp.com/api/users/user/setActive${payload}`
            );
            return dispatch({
                type: SET_ACTIVE,
    ...
    return async (dispatch) => {
        try {
            ...
            let setActiveManga = await axios.put(
                `https://deploy-back-mangaka-v2.herokuapp.com/api/mangas/manga/setActive${payload}`
            );
            return dispatch({
    ...
    return async (dispatch) => {
        try {
            ...
            let setAdmin = await axios.put(
                `https://deploy-back-mangaka-v2.herokuapp.com/api/users/user/setAdmin${payload}`
            );
            return dispatch({
                type: SET_ADMIN,
